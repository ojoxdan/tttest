+function ($) {
    ...
    PopVideo.prototype.init = function (element, options) {
        ...
        this.popid = popid
        //自定义控制界面
        var control = " <svg className=\"popvideo_svg_sprite\" display=\"none\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
            ...
            "            </symbol>\n" +
            "        </svg>\n" +
            "        <div data-role=\"popvideo-control-wrap\" className=\"popvideo-control-wrap\">\n" +
            "            <div className=\"popvideo_progress_bar_container\" data-role=\"popvideo-control-progress\">\n" +
            "                <div className=\"popvideo_progress_list\" data-role=\"popvideo-control-progress-list\">\n" +
            "                    <div className=\"popvideo_progress_load\"></div>\n" +
            "                    <div className=\"popvideo_progress_play\"></div>\n" +
            "                </div>\n" +
            "                <div className=\"popvideo_btn_scrubber\"><div className=\"popvideo_scrubber_indicator\"></div></div>" +
            "            </div>\n" +
            "            <div className=\"popvideo_controls\">\n" +
            "                <div className=\"popvideo_left_controls\" data-role=\"popvideo-control-left\">\n" +
            "                    <div data-role=\"popvideo-ui-control-playbtn\" className=\"popvideo_btn popvideo_btn_play\"\n" +
            "                         data-status=\"play\">\n" +
            "                        <svg className=\"popvideo_icon popvideo_icon_play\" version=\"1.1\" viewBox=\"0 0 36 36\">\n" +
            "                            <use className=\"popvideo_svg_symbol popvideo_svg_play\"\n" +
            "                                 xmlns:xlink=\"http://www.w3.org/1999/xlink\"\n" +
            "                                 xlink:href=\"#popvideo_svg_play\"></use>\n" +
            "                            <use className=\"popvideo_svg_symbol popvideo_svg_pause\"\n" +
            "                                 xmlns:xlink=\"http://www.w3.org/1999/xlink\"\n" +
            "                                 xlink:href=\"#popvideo_svg_pause\"></use>\n" +
            "                            <use className=\"popvideo_svg_symbol popvideo_svg_replay\"\n" +
            "                                 xmlns:xlink=\"http://www.w3.org/1999/xlink\"\n" +
            "                                 xlink:href=\"#popvideo_svg_replay\"></use>\n" +
            "                        </svg>\n" +
            "                    </div>\n" +
            "                    <div data-role=\"popvideo-control-time-mod\" className=\"popvideo_time_display\">\n" +
            "                        <div className=\"popvideo_time_current\" >00:00</div>\n" +
            "                        <div className=\"popvideo_time_separator\">/</div>\n" +
            "                        <div className=\"popvideo_time_duration\" >00:00</div>\n" +
            "                    </div>\n" +
            "                </div>\n" +
            "                <div className=\"popvideo_right_controls\" data-role=\"popvideo-control-right\">\n" +
            "                    <div className=\"popvideo_btn popvideo_btn_volume\" data-role=\"popvideo-control-volume-button\"\n" +
            "                         data-status=\"normal\">\n" +
            "                        <svg className=\"popvideo_icon popvideo_icon_volume\" version=\"1.1\" viewBox=\"0 0 24 24\">\n" +
            "                            <use className=\"popvideo_svg_symbol popvideo_svg_volume\"\n" +
            "                                 xmlns:xlink=\"http://www.w3.org/1999/xlink\"\n" +
            "                                 xlink:href=\"#popvideo_svg_volume\"></use>\n" +
            "                            <use className=\"popvideo_svg_symbol popvideo_svg_volume_mute\"\n" +
            "                                 xmlns:xlink=\"http://www.w3.org/1999/xlink\"\n" +
            "                                 xlink:href=\"#popvideo_svg_volume_mute\"></use>\n" +
            "                        </svg>\n" +
            "                        <div className=\"popvideo_volume_range\">\n" +
            "                            <div className=\"popvideo_volume_range_current\" style=\"width: 50%;\">\n" +
            "                                <div className=\"popvideo_volume_handle\" style=\"left: 50%;\"></div>\n" +
            "                            </div>\n" +
            "                        </div>\n" +
            "                    </div>\n" +
            "                    <div className=\"popvideo_btn popvideo_btn_fullscreen\"\n" +
            "                         data-status=\"false\"\n" +
            "                         data-report=\"window-fullscreen\">\n" +
            "                        <svg className=\"popvideo_icon popvideo_icon_fullscreen\" version=\"1.1\" viewBox=\"0 0 24 24\">\n" +
            "                            <use className=\"popvideo_svg_symbol popvideo_svg_fullscreen\"\n" +
            "                                 xmlns:xlink=\"http://www.w3.org/1999/xlink\"\n" +
            "                                 xlink:href=\"#popvideo_svg_fullscreen\"></use>\n" +
            "                            <use className=\"popvideo_svg_symbol popvideo_svg_fullscreen_true\"\n" +
            "                                 xmlns:xlink=\"http://www.w3.org/1999/xlink\"\n" +
            ...
            "            </div>\n" +
            "        </div>";
        var tpl = '<div className="popvideo-wrapper" id="' + popid + '">' +
            '<div className="popvideo">' +
            '<div className="popvideo-head"><a href="javascript:void(0)" className="popvideo-close">&times;</a><h4 className="popvideo-title">' + this.options.title + '</h4></div>' +
            '<div className="popvideo-content">' + '<video webkit-playsinline="true"></video></div>' +
            control +
            '</div></div>';
        $('body').append(tpl);
        this.$wrapper = $('#' + popid);
